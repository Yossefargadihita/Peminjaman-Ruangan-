                ...
                <div class="card shadow-lg border-0">
                    <div class="card-header bg-primary text-white py-3">
                        <h2 class="mb-0 text-center">
                            ...
                            {{ ucfirst($type) }} Ruangan: {{ $room->name }}
                        </h2>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('bookings.store', $room) }}" class="needs-validation"
                            novalidate>
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date" name="start_date" id="start_date"
                                        class="form-control form-control-lg" value="{{ old('start_date') }}"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date" name="end_date" id="end_date"
                                        class="form-control form-control-lg" value="{{ old('end_date') }}"
                                        min="{{ date('Y-m-d') }}" required>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="tel" name="no_hp" id="no_hp" class="form-control form-control-lg"
                                        value="{{ old('no_hp') }}" placeholder="08xxxxxxxxxx" pattern="[0-9]{10,13}"
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" name="jumlah_peserta" id="jumlah_peserta"
                                        class="form-control form-control-lg" value="{{ old('jumlah_peserta') }}"
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="{{ route('dashboard') }}" class="btn btn-outline-secondary btn-lg me-md-2">
