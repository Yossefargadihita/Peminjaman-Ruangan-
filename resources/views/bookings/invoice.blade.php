                ...
                <div class="card border-0 shadow-lg">
                    ...
                    <div class="card-body p-4">
                            ...
                            <div class="col-md-6">
                                <div class="bg-light rounded-3 p-3 h-100">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <span class="ms-2">{{ $booking->user->name }}</span>
                                    </div>
                                    <div class="mb-2">
                                        <strong class="text-muted">No. HP:</strong>
                                        <span class="ms-2">{{ $booking->no_hp }}</span>
                                    </div>
                                    <div class="mb-2">
                                        <strong class="text-muted">Alamat:</strong>
                                        <span class="ms-2">{{ $booking->alamat }}</span>
                                    </div>
                                    <div>
                                        <strong class="text-muted">Jumlah Peserta:</strong>
                                        <span class="ms-2 badge bg-info">{{ $booking->jumlah_peserta }} orang</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="bg-light rounded-3 p-3 h-100">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <span class="ms-2 badge bg-secondary">{{ ucfirst($booking->type) }}</span>
                                    </div>
                                    <div class="mb-2">
                                        <strong class="text-muted">Tanggal:</strong>
                                        <span class="ms-2">{{ $booking->start_date }} s.d {{ $booking->end_date }}</span>
                                    </div>
                                    <div class="mb-2">
                                        <strong class="text-muted">Lama Sewa:</strong>
                                        <span class="ms-2 badge bg-warning text-dark">{{ $duration }} hari</span>
                                    </div>
                                    <div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <span
                                                class="fw-bold">Rp{{ number_format($booking->room->rental_price, 0, ',', '.') }}</span>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex gap-3 flex-wrap">
                            ...
                            @endif
                            <a href="{{ route('dashboard') }}" class="btn btn-outline-secondary btn-lg px-4 py-2">
                ...
                payButton.addEventListener('click', function() {
                    ...
                    snap.pay('{{ $snapToken }}', {
                        onSuccess: function(result) {
                            ...
                            fetch("{{ route('bookings.pay', $booking->id) }}", {
                                method: "POST",
                                headers: {
